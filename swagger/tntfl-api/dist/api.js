...
var BASE_PATH = "http://www.int.corefiling.com/~tlr/tntfl";
 ...
 */
exports.GamesApiFetchParamCreactor = {
    /**
     * Add a game
     * Add a game.
     ...
     * @param blueScore The blue team score
     */
    addGameRedirect: function (params) {
        // verify required parameter "redPlayer" is set
        if (params["redPlayer"] == null) {
     ...
     */
    getHeadToHeadGames: function (params) {
...
exports.GamesApiFp = {
     ...
     */
    addGame: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.addGame(params);
     ...
     */
    addGameRedirect: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.addGameRedirect(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getGame: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.getGame(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getGames: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.getGames(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getHeadToHeadGames: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.getHeadToHeadGames(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getPunditry: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.getPunditry(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getRecent: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.getRecent(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    predict: function (params) {
        var fetchArgs = exports.GamesApiFetchParamCreactor.predict(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
...
var GamesApi = (function (_super) {
     ...
     * @param blueScore The blue team score
     */
    GamesApi.prototype.addGame = function (params) {
        return exports.GamesApiFp.addGame(params)(this.fetch, this.basePath);
    };
    /**
     * Add a game
     * Add a game.
     ...
     * @param blueScore The blue team score
     */
    GamesApi.prototype.addGameRedirect = function (params) {
        return exports.GamesApiFp.addGameRedirect(params)(this.fetch, this.basePath);
    };
    /**
     * Get a game
     * Get a game.
     * @param gameId Timestamp of the game
     */
    GamesApi.prototype.getGame = function (params) {
        return exports.GamesApiFp.getGame(params)(this.fetch, this.basePath);
    };
    /**
     * Get games
     * Get games.
     ...
     * @param end Timestamp to filter to.
     */
    GamesApi.prototype.getGames = function (params) {
        return exports.GamesApiFp.getGames(params)(this.fetch, this.basePath);
    };
    /**
     * Get shared games
     * Get shared games.
     ...
     * @param player2 Name of player 2
     */
    GamesApi.prototype.getHeadToHeadGames = function (params) {
        return exports.GamesApiFp.getHeadToHeadGames(params)(this.fetch, this.basePath);
    };
    /**
     * Get game punditry
     * Get game punditry.
     * @param gameId Timestamp of game
     */
    GamesApi.prototype.getPunditry = function (params) {
        return exports.GamesApiFp.getPunditry(params)(this.fetch, this.basePath);
    };
    /**
     * Get recent games
     * Get recent games.
     * @param limit Maximum number of games to return
     */
    GamesApi.prototype.getRecent = function (params) {
        return exports.GamesApiFp.getRecent(params)(this.fetch, this.basePath);
    };
    /**
     * Predict the outcome of a game
     * Predict the outcome of a game.
     ...
     * @param blueElo Elo of blue player
     */
    GamesApi.prototype.predict = function (params) {
        return exports.GamesApiFp.predict(params)(this.fetch, this.basePath);
    };
    return GamesApi;
})(BaseAPI);
...
exports.GamesApiFactory = function (fetch, basePath) {
    return {
         ...
         */
        addGame: function (params) {
            return exports.GamesApiFp.addGame(params)(fetch, basePath);
        },
        /**
         * Add a game
         * Add a game.
         ...
         */
        addGameRedirect: function (params) {
            return exports.GamesApiFp.addGameRedirect(params)(fetch, basePath);
        },
        /**
         * Get a game
         * Get a game.
         ...
         */
        getGame: function (params) {
            return exports.GamesApiFp.getGame(params)(fetch, basePath);
        },
        /**
         * Get games
         * Get games.
         ...
         */
        getGames: function (params) {
            return exports.GamesApiFp.getGames(params)(fetch, basePath);
        },
        /**
         * Get shared games
         * Get shared games.
         ...
         */
        getHeadToHeadGames: function (params) {
            return exports.GamesApiFp.getHeadToHeadGames(params)(fetch, basePath);
        },
        /**
         * Get game punditry
         * Get game punditry.
         ...
         */
        getPunditry: function (params) {
            return exports.GamesApiFp.getPunditry(params)(fetch, basePath);
        },
        /**
         * Get recent games
         * Get recent games.
         ...
         */
        getRecent: function (params) {
            return exports.GamesApiFp.getRecent(params)(fetch, basePath);
        },
        /**
         * Predict the outcome of a game
         * Predict the outcome of a game.
         ...
         */
        predict: function (params) {
            return exports.GamesApiFp.predict(params)(fetch, basePath);
        },
    };
};
/**
 ...
 */
exports.LadderApiFetchParamCreactor = {
    /**
     * Get the ladder
     * Get the ladder.
     ...
     * @param players Include detailed player info
     */
    getLadderBetween: function (params) {
        // verify required parameter "begin" is set
        if (params["begin"] == null) {
...
exports.LadderApiFp = {
     ...
     */
    getLadder: function (params) {
        var fetchArgs = exports.LadderApiFetchParamCreactor.getLadder(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getLadderBetween: function (params) {
        var fetchArgs = exports.LadderApiFetchParamCreactor.getLadderBetween(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    speculate: function (params) {
        var fetchArgs = exports.LadderApiFetchParamCreactor.speculate(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
...
var LadderApi = (function (_super) {
     ...
     * @param players Include detailed player info
     */
    LadderApi.prototype.getLadder = function (params) {
        return exports.LadderApiFp.getLadder(params)(this.fetch, this.basePath);
    };
    /**
     * Get the ladder
     * Get the ladder.
     ...
     * @param players Include detailed player info
     */
    LadderApi.prototype.getLadderBetween = function (params) {
        return exports.LadderApiFp.getLadderBetween(params)(this.fetch, this.basePath);
    };
    /**
     * Get the ladder
     * Get the ladder.
     ...
     * @param previousGames CSV of speculative games
     */
    LadderApi.prototype.speculate = function (params) {
        return exports.LadderApiFp.speculate(params)(this.fetch, this.basePath);
    };
    return LadderApi;
})(BaseAPI);
...
exports.LadderApiFactory = function (fetch, basePath) {
    return {
         ...
         */
        getLadder: function (params) {
            return exports.LadderApiFp.getLadder(params)(fetch, basePath);
        },
        /**
         * Get the ladder
         * Get the ladder.
         ...
         */
        getLadderBetween: function (params) {
            return exports.LadderApiFp.getLadderBetween(params)(fetch, basePath);
        },
        /**
         * Get the ladder
         * Get the ladder.
         ...
         */
        speculate: function (params) {
            return exports.LadderApiFp.speculate(params)(fetch, basePath);
        },
    };
};
/**
 ...
 */
exports.PlayersApiFetchParamCreactor = {
    /**
     ...
     */
    getPerPlayerStats: function (params) {
     ...
     * @param player ID of the player
     */
    getPlayerAchievements: function (params) {
        // verify required parameter "player" is set
        if (params["player"] == null) {
     ...
     * @param player ID of the player
     */
    getPlayerGames: function (params) {
        // verify required parameter "player" is set
        if (params["player"] == null) {
...
exports.PlayersApiFp = {
     ...
     */
    getActive: function (params) {
        var fetchArgs = exports.PlayersApiFetchParamCreactor.getActive(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getPerPlayerStats: function (params) {
        var fetchArgs = exports.PlayersApiFetchParamCreactor.getPerPlayerStats(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getPlayer: function (params) {
        var fetchArgs = exports.PlayersApiFetchParamCreactor.getPlayer(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getPlayerAchievements: function (params) {
        var fetchArgs = exports.PlayersApiFetchParamCreactor.getPlayerAchievements(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
     ...
     */
    getPlayerGames: function (params) {
        var fetchArgs = exports.PlayersApiFetchParamCreactor.getPlayerGames(params);
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
...
var PlayersApi = (function (_super) {
     ...
     * @param at CSV of timestamps
     */
    PlayersApi.prototype.getActive = function (params) {
        return exports.PlayersApiFp.getActive(params)(this.fetch, this.basePath);
    };
    /**
     * Get per player stats
     * Get per player stats.
     * @param player ID of the player
     */
    PlayersApi.prototype.getPerPlayerStats = function (params) {
        return exports.PlayersApiFp.getPerPlayerStats(params)(this.fetch, this.basePath);
    };
    /**
     * Get player info
     * Get player info.
     * @param player ID of the player
     */
    PlayersApi.prototype.getPlayer = function (params) {
        return exports.PlayersApiFp.getPlayer(params)(this.fetch, this.basePath);
    };
    /**
     * Get player&#39;s achievements
     * Get player&#39;s achievements.
     * @param player ID of the player
     */
    PlayersApi.prototype.getPlayerAchievements = function (params) {
        return exports.PlayersApiFp.getPlayerAchievements(params)(this.fetch, this.basePath);
    };
    /**
     * Get player&#39;s games
     * Get player&#39;s games.
     * @param player ID of the player
     */
    PlayersApi.prototype.getPlayerGames = function (params) {
        return exports.PlayersApiFp.getPlayerGames(params)(this.fetch, this.basePath);
    };
    return PlayersApi;
})(BaseAPI);
...
exports.PlayersApiFactory = function (fetch, basePath) {
    return {
         ...
         */
        getActive: function (params) {
            return exports.PlayersApiFp.getActive(params)(fetch, basePath);
        },
        /**
         * Get per player stats
         * Get per player stats.
         ...
         */
        getPerPlayerStats: function (params) {
            return exports.PlayersApiFp.getPerPlayerStats(params)(fetch, basePath);
        },
        /**
         * Get player info
         * Get player info.
         ...
         */
        getPlayer: function (params) {
            return exports.PlayersApiFp.getPlayer(params)(fetch, basePath);
        },
        /**
         * Get player&#39;s achievements
         * Get player&#39;s achievements.
         ...
         */
        getPlayerAchievements: function (params) {
            return exports.PlayersApiFp.getPlayerAchievements(params)(fetch, basePath);
        },
        /**
         * Get player&#39;s games
         * Get player&#39;s games.
         ...
         */
        getPlayerGames: function (params) {
            return exports.PlayersApiFp.getPlayerGames(params)(fetch, basePath);
        },
    };
};
/**
 ...
 */
exports.StatsApiFetchParamCreactor = {
    /**
     * Get global stats
     * Get global stats.
     */
...
exports.StatsApiFp = {
     ...
     */
    getStats: function () {
        var fetchArgs = exports.StatsApiFetchParamCreactor.getStats();
        return function (fetch, basePath) {
            if (fetch === void 0) { fetch = isomorphicFetch; }
            if (basePath === void 0) { basePath = BASE_PATH; }
            return fetch(basePath + fetchArgs.url, fetchArgs.options).then(function (response) {
...
var StatsApi = (function (_super) {
     ...
     * Get global stats.
     */
    StatsApi.prototype.getStats = function () {
        return exports.StatsApiFp.getStats()(this.fetch, this.basePath);
    };
    return StatsApi;
})(BaseAPI);
...
exports.StatsApiFactory = function (fetch, basePath) {
    return {
         ...
         */
        getStats: function () {
            return exports.StatsApiFp.getStats()(fetch, basePath);
        },
    };
};
